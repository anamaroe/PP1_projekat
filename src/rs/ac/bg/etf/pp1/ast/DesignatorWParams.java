...
public class DesignatorWParams extends DesignatorStatement {

    private MethodName MethodName;
    private ActualParams ActualParams;

    public DesignatorWParams (MethodName MethodName, ActualParams ActualParams) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorWParams(\n");
