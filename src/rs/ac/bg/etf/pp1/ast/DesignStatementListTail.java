...
public class DesignStatementListTail extends DesignatorStatementsListTail {

    private ForLoopDesignatorStatements ForLoopDesignatorStatements;

    public DesignStatementListTail (ForLoopDesignatorStatements ForLoopDesignatorStatements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignStatementListTail(\n");
